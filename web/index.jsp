...
<jsp:include page="/indexInit" flush="false"/>
<!DOCTYPE html>
<head>
...
<div id="featureCarousel" class="carousel slide" data-ride="carousel" style="margin-top: 48px">
    ...
    <ul class="nav nav-pills nav-justified">
        ...
        <li data-target="#featureCarousel" data-slide-to="2" class="active"><a href="#" style="font-size:21px">工科</a>
        </li>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <c:forEach var="question" items="${qlist}" begin="0" end="1">
                                        <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <c:forEach var="question" items="${qlist}" begin="2" end="3">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <a href="/pq/${question.id}" style="font-size:15px">
                                                        ${question.tittle}</a>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <c:forEach var="question" items="${qlist}" begin="4" end="5">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <a href="/pq/${question.id}" style="font-size:15px">
                                                        ${question.tittle}</a>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <c:forEach var="question" items="${qlist}" begin="6" end="7">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <a href="/pq/${question.id}" style="font-size:15px">
                                                        ${question.tittle}</a>
